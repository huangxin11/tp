...
<div class="data-table table-striped">
    <table>
        ...
        <tbody>
        <?php if(!(empty($servers) || (($servers instanceof \think\Collection || $servers instanceof \think\Paginator ) && $servers->isEmpty()))): if(is_array($servers) || $servers instanceof \think\Collection || $servers instanceof \think\Paginator): $i = 0; $__LIST__ = $servers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$servers): $mod = ($i % 2 );++$i;?>
        <tr>
            <td><input class="ids row-selected" type="checkbox" name="" id="" value="<?php echo $servers['id']; ?>"> </td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo $servers['id']; ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo $servers['sn']; ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo $servers['title']; ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo $servers['content']; ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo $servers['name']; ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo $servers['address']; ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo $servers['tel']; ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo time_format($servers['create_time']); ?></a></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$servers['id']); ?>">编辑</a>
                <a class="confirm ajax-get" title="删除" href="<?php echo url('server/del?id='.$servers['id']); ?>">删除</a>
            </td>
        </tr>

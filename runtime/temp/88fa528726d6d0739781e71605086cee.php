<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\www\tp\public/../application/admin/view/default/server\add.html";i:1511674511;s:67:"D:\www\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title">
    <h2>
        <?php echo !empty($server['id'])?'编辑':'新增'; ?>保修订单
    </h2>
</div>
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    <input type="hidden" name="id" value="<?php echo $server['id']; ?>">
    <div class="form-item">
        <label class="item-label">保修人<span class="check-tips"></span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="name" value="<?php echo (isset($server['name']) && ($server['name'] !== '')?$server['name']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">订单标题<span class="check-tips"></span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="title" value="<?php echo (isset($server['title']) && ($server['title'] !== '')?$server['title']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">电话号码<span class="check-tips"></span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="tel" value="<?php echo (isset($server['tel']) && ($server['tel'] !== '')?$server['tel']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">地址<span class="check-tips"></span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="address" value="<?php echo (isset($server['address']) && ($server['address'] !== '')?$server['address']:''); ?>">
        </div>
        <!--<div class="controls">-->
            <!--<select name="target">-->
    ...
    <div class="form-item">
        ...
        <div class="controls">
            ...
            <textarea name="content" style="width:400px; height: 100px;"><?php echo (isset($server['content']) && ($server['content'] !== '')?$server['content']:''); ?></textarea>
        </div>
    </div>
    <div class="form-item">

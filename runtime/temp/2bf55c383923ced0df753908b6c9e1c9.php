<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\www\tp\public/../application/admin/view/default/shop\index.html";i:1511937812;s:67:"D:\www\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tbody>
        <?php if(!(empty($shop) || (($shop instanceof \think\Collection || $shop instanceof \think\Paginator ) && $shop->isEmpty()))): if(is_array($shop) || $shop instanceof \think\Collection || $shop instanceof \think\Paginator): $i = 0; $__LIST__ = $shop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shop): $mod = ($i % 2 );++$i;?>
        <tr>
            <td><input class="ids row-selected" type="checkbox" name="" id="" value="<?php echo $shop['id']; ?>"> </td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo $shop['id']; ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo $shop['title']; ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo $shop['content']; ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo time_format($shop['start_time']); ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo time_format($shop['end_time']); ?></a></td>
            <td><a href="<?php echo url('index?pid='.$servers['id']); ?>"><?php echo !empty($shop['status']) && $shop['status']==1?'已发布':'未发布'; ?></a></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$shop['id']); ?>">编辑</a>

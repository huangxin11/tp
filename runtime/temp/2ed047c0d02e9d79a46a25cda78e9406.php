<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\www\tp\public/../application/home/view/default/profile\index.html";i:1512025569;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        ...
        <div id="mydiv">
            ...
            <div class="row noticeList">
                <a href="/home/shop/shop_article?id=<?php echo $shop['id']; ?>">
                    <div class="col-xs-2">
...
<script type="text/javascript">
    $("#add").click(function () {
        ...
        int = parseInt(int);
        page = int+1;
        $.getJSON('/home/shop/index',{page:page},function (noice) {
            var data = $.parseJSON(noice);
            $('#page').text(data['page']);
            $.each(data,function (index) {
                if (index <= 2){
                    $.post('/home/shop/path',{cover_id:data[index].cover_id,end:data[index].deadline,time:data[index].create_time},function (path) {
                        var  end = path['end'];
                        var  path1 = path['path'];
                        var time = path['time'];
                        $("<div class='row noticeList'><a href='/home/shop/shop_article?id="+data[index].id+"'>\
                        \       <div class='col-xs-2'>\

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\www\tp\public/../application/admin/view/default/shop\add.html";i:1511937201;s:67:"D:\www\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title">
    <h2>
        <?php echo !empty($shop['id'])?'编辑':'新增'; ?>商家活动
    </h2>
</div>
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="text" class="text input-large" name="title" value="<?php echo (isset($shop['title']) && ($shop['title'] !== '')?$shop['title']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">活动开始时间<span class="check-tips"></span></label>
        <div class="controls">
            <input type="datetime-local" class="text input-large" name="start_time" value="<?php echo (isset($shop['start_time']) && ($shop['start_time'] !== '')?$shop['start_time']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">活动结束时间<span class="check-tips"></span></label>
        <div class="controls">
            <input type="datetime-local" class="text input-large" name="end_time" value="<?php echo (isset($shop['end_time']) && ($shop['end_time'] !== '')?$shop['end_time']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">是否发布<span class="check-tips"></span></label>
        <div class="controls">
            <input type="radio"  name="status" value="1" <?php echo !empty($shop['status']) && $shop['status']==1?'checked':''; ?>>是
            <input type="radio"  name="status" value="2" <?php echo !empty($shop['status']) && $shop['status']==2?'checked':''; ?>>否
        </div>
        <!--<div class="controls">-->
        <!--<select name="target">-->
    ...
    <div class="form-item">
        ...
        <div class="controls">
            ...
            <textarea name="content" style="width:400px; height: 100px;"><?php echo (isset($shop['content']) && ($shop['content'] !== '')?$shop['content']:''); ?></textarea>
        </div>
    </div>
    <div class="form-item">

...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="row noticeList">
            <a href="/home/notice/notice_article?id=<?php echo $notice['id']; ?>">
                <div class="col-xs-2">
...
<script type="text/javascript">
  $("#add").click(function () {
      ...
      int = parseInt(int)
      page = int+1;
      $.getJSON('/home/notice/index',{page:page},function (noice) {
          var data = $.parseJSON(noice);
          $('#page').text(data['page']);
          $.each(data,function (index) {
              if (index <= 2){
                  $.post('/home/notice/path',{cover_id:data[index].cover_id,time:data[index].create_time},function (path) {
                     var  path1 = path['path'];
                     var time = path['time'];
                  $("<div class='row noticeList'><a href='/home/notice/notice_article?id="+data[index].id+"'>\
            <div class='col-xs-2'>\
